...
import kimplementasi.mayanglass;
 ...
 * @author microsoft
 */
public class mayangclass extends javax.swing.JFrame {
    List <model> record = new ArrayList<>();
    Interface mayangservice;
    int row;

    /**
     * Creates new form mayangclass
     */
    public mayangclass() {
        initComponents();
        mayangservice = new mayanglass();
        this.refresdata();
    }
private void baru(){
...
isitabel();
    ...
    private void jBTN_HAPUSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBTN_HAPUSActionPerformed
        ...
        // if(id.trim().equals("") && nama.trim().equals("")){
            ...
            //}else{
            try {
                mayangservice.hapus(jTBL_Teman.getValueAt(row, 0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mayangclass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mayangclass().setVisible(true);
            }
        });
    }
